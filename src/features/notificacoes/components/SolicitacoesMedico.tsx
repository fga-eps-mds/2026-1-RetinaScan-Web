...
const SolicitacoesMedico = () => {
  const { data: solicitacoes = [], isPending, isError, error } = useGetMinhasSolicitacoesCpfCrm();
    ...
    return (
      <Card className="border-destructive/20 bg-destructive/5">
        <CardContent className="p-6">
          <p className="text-sm font-medium text-destructive">Erro ao carregar solicitações.</p>
    ...
    return (
      <Card className="border-dashed border-border/80 bg-muted/20">
        <CardContent className="flex flex-col items-center justify-center p-10 text-center">
          ...
          <h3 className="text-base font-semibold text-foreground">Nenhuma solicitação encontrada</h3>
