...
describe('MetricsSection', () => {
  ...
  it('deve renderizar todos os 6 cards de métricas com os títulos corretos', () => {
    ...
    expect(screen.getByText('Análises Totais')).toBeInTheDocument();
    expect(screen.getByText('A Especialista')).toBeInTheDocument();
